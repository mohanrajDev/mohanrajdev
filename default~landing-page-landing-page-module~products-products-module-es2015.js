...
ProductItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProductItemComponent, selectors: [["product-item"]], inputs: { product: "product" }, decls: 11, vars: 10, consts: [[3, "routerLink"], ["nzHoverable", "", 3, "nzCover"], [1, "card-body"], ["coverTemplate", ""], [3, "alt", "src"], [4, "ngIf", "ngIfElse"], ["elseTemplate", ""], ["nz-icon", "", "nzType", "heart", "nzTheme", "fill", 1, "wishlist", "filled", 3, "click"], ["nz-icon", "", "nzType", "heart", "nzTheme", "outline", 1, "wishlist", 3, "click"]], template: function ProductItemComponent_Template(rf, ctx) { if (rf & 1) {
